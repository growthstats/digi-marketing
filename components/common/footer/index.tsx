      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        {/* <div className="mx-auto max-w-md">
          ...
          <form className="mt-6">
            <div className="relative max-w-lg">
              ...
              <input
                className="w-full rounded-full border-gray-700 bg-gray-800 p-4 pe-32 text-sm font-medium text-white dark:border-gray-200 dark:bg-gray-100 dark:text-gray-900"
                id="email"
                type="email"
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div className="mx-auto max-w-sm lg:max-w-none">
            <p className="mt-4 text-center text-gray-400 lg:text-left lg:text-lg dark:text-gray-500">
              Growth Stats is more than just a service provider. We&apos;re your partner in navigating the digital landscape, committed to
              innovation, excellence, and shared success. Stay connected with us on social media.
            </p>
            ...
            <div className="mt-6 flex justify-center gap-4 lg:justify-start">
              ...
              >
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" tabIndex={-1}>
                  <path
                    fillRule="evenodd"
          ...
          <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
            ...
            <div>
              <strong className="font-medium dark:text-gray-900 text-white"> Support </strong>
