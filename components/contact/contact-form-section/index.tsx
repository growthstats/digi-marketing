...
const ContactFormSection: FC<IContactFormSectionProps> = () => (
  <Section className={cx(styles['d-section'])}>
    ...
    <Box className={cx(styles['d-section__form-container'])}>
      ...
      <form className={cx(styles['d-section__contact-form'])}>
        <Box className={cx(styles['d-section__form-fields-row'])}>
          <Box className={cx(styles['d-section__form-fields-col'])}>
            ...
            <Box className={cx(styles['d-section__form-control'])}>
              <input name="cname" type="text" placeholder="Name" className={cx(styles['d-section__form-control-text-input'])} />
            ...
            {/* Email */}
            <Box className={cx(styles['d-section__form-control'])}>
              <input name="email" type="text" placeholder="Email" className={cx(styles['d-section__form-control-text-input'])} />
            ...
            {/* Phone */}
            <Box className={cx(styles['d-section__form-control'])}>
              <input name="phone" type="text" placeholder="Phone" className={cx(styles['d-section__form-control-text-input'])} />
